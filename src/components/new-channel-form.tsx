  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex flex-col gap-[45px] px-[67px]"
      >
        <FormField
              ...
              <div className="flex justify-between items-center">
                ...
                <FormControl>
                  <Input
                    type="datetime-local"
                    {...field}
                    className="border-[#9EC79B] border-b-[3px] border-t-0 border-x-0 rounded-none placeholder:font-light placeholder:text-white placeholder:italic focus-visible:ring-0 w-auto"
                  />
                </FormControl>
              </div>
              <FormMessage />
